...
@interface CallerOrgListViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
@implementation CallerOrgListViewController
...
- (void)viewDidLoad {
    ...
    [self setupBackBtnNavBarWithTitle:@"选择部门"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CallerOrgModel *model = self.listArr[indexPath.row];
...
- (void)refreshList{
    ...
    [store getPartListWithSchoolId:[UserDefaultsTool getSchoolId] Success:^(NSArray *arr) {
