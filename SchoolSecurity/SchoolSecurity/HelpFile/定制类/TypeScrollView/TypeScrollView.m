...
- (void)setup
{
    ...
    for (int i = 0; i < self.titles.count; i++) {
        ...
        [button setTitleColor:[UIColor colorWithHexString:@"#A5A3A3"] forState:UIControlStateNormal];
        [button setTitleColor:[UIColor colorWithHexString:@"#FDB133"] forState:UIControlStateDisabled];
        
        button.titleLabel.font = [UIFont systemFontOfSize:15 weight:0.1];
        
        if (i == 0) {
            button.titleLabel.font = [UIFont systemFontOfSize:17 weight:0.2];
        }
...
- (void)didTypeClick:(UIButton *)button
{
    ...
    self.button.titleLabel.font = [UIFont systemFontOfSize:15 weight:0.1];
